...
vim.keymap.set("n", "<C-j>", function() require("samharju.crumbs").crumbs_show_virt() end)
vim.keymap.set("n", "<C-h>", function() require("samharju.crumbs").crumbs_show_context() end)
